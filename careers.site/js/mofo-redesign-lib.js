...
(function ($) {
    $(function () {
        /** Sticky Video Player - Adapted from https://codepen.io/aravi-pen/pen/VMaRvX */
        ...
        ytIframeList = document.querySelectorAll(".content-block iframe");
        for (i = 0; i < ytIframeList.length; i++) {
            ...
            if (url[2] !== undefined) {
                ...
                $responsiveWrapper.classList.add('media-wrap', 'embed-responsive', 'embed-responsive-16by9')
                if (ytIframeList[i].classList.contains('sticky-video')) {
                    if (!new RegExp("\\b" + "enablejsapi" + "\\b").test(ytIframeList[i].src)) {
                        var param = 'enablejsapi=true';
                        var connector = (-1 < ytIframeList[i].src.indexOf('?')) ? '&' : '?';
                        ytIframeList[i].src = ytIframeList[i].src + connector + param;
                    }
                    ytIframeList[i].id = "featured-video" + i;
                    $responsiveWrapper.classList.add("sticky");
                    var closeButton = document.createElement("a");
                    closeButton.classList.add("close-button");
                    var gradientOverlay = document.createElement("div");
                    gradientOverlay.classList.add("gradient-overlay")
                    var arrow = document.createElement("i");
                    arrow.classList.add("fa", "fa-arrows-alt");
                    $responsiveWrapper.appendChild(closeButton);
                    $responsiveWrapper.appendChild(gradientOverlay);
                    $responsiveWrapper.appendChild(arrow);
                    
                }
                $responsiveWrapper.appendChild(ytIframeList[i].cloneNode(true))
                ytIframeList[i].parentNode.replaceChild($responsiveWrapper, ytIframeList[i])

                if (ytIframeList[i].classList.contains('sticky-video') && new RegExp("\\b" + "enablejsapi" + "\\b").test(ytIframeList[i].src)) {
